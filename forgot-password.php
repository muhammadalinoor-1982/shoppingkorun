...
<section class="main-container col1-layout">
            ...
            <div class="content">
              ...
              <ul class="form-list">
                ...
                <li>
                  ...
                  <input type="email" title="E-Mail" id="email" class="input-text required-entry validate-password" name="email">
                </li>
              </ul>
  ...
  <footer>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="contacts-info">
              ...
              <div class="email-footer"><i class="fa fa-envelope"></i> <a href="mailto:aupuchowdhury@shoppingkorun.com">aupuchowdhury@shoppingkorun.com</a> </div>
            </div>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-xs-12 coppyright text-center">© 2018 shoppingkorun.com, All rights reserved.</div>
        </div>
      </div>
    </div>
  </footer>
