<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM count_down WHERE count_id = '$count_id'");
...
<title>NOOR Enterprise Count Down Update</title>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Count Down Update</li>
                    </ul>
                </div>
            </div>
        </div>
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Count Down Update</h2>
                                    <form action="controller/countDownUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Count Name</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['count_name']; ?>" name="count_name"  required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Count Down</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['count_down']; ?>" name="count_down"  required>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <select class="form-control show-tick" name="count_status" required>
                                                                        <option value="">-- Choose status --</option>
                                                                        <option value="1"<?php if($data[0]['count_status']==1) echo 'selected'; ?>>Active</option>
                                                                        <option value="0"<?php if($data[0]['count_status']==0) echo 'selected'; ?>>Inactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                <div class="col-lg-6 col-md-12">
                                                            <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                                                ...
                                                                <input type="file" name="count_image" id="file-upload" />
                                                                <img src="uploads/countDown/<?php echo $data[0]['count_image']; ?>" width="100" >
                                                        </div>

                                                <input type="hidden" name="old_img" value="<?php echo $data[0]['count_image']; ?>">
                                                <input type="hidden" name="count_id" value="<?php echo $data[0]['count_id']; ?>">
