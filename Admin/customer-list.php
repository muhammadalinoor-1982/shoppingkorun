<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM customer");
  $message = $obj->getData("SELECT * FROM message");
...
<title>NOOR Enterprise brand List</title>
                ...
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <!-- start data table -->
                        ...
                        <div class="table-responsive">
                            <form action="controller/messageMailProcess.php" method="post" enctype="multipart/form-data">
                            ...
                            <table id="example" class="table table-bordered table-striped table-hover dataTable">
                                    <thead>
                                        <tr>
                                            <th>Select All<input type="checkbox" name="checkboxall" id="all" style="position: relative; top: 0px; left: 10px; height: 0px; width: 0px;background-color: #ffffff; opacity: 1;" /></th>
                                            <th>Picture</th>
                                            <th>ID</th>
                                            <th>Name</th>
                                            <th>Phone</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="checkbox[]" value="<?php echo $value['customer_id']; ?>" class="selectAll" style="position: relative; top: 40px; left: 30px; background: blue; border-radius: 4px; opacity: 1; " /></td>
                                            <td><img src="uploads/customer_pro_pic/<?php echo $value['cust_images'] ? $value['cust_images'] : 'no-image.jpg' ; ?>" width="50" height="50"></td>
                                            ...
                                            <td>
                                               <a href="#" style="color: red" onclick="return confirm('Delete All Data of the Row')"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span></div></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                 </tbody>
                                ...
                                <!-- Start message -->
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="pn"><h6 class="noor_h6"><span class="noor_span">*</span> Message</h6></label>
                                                <select class="form-control show-tick" data-live-search="true" name="head" required>
                                                    <option value="">-- Chose Message --</option>
                                                    <?php foreach($message as $messages){ ?>
                                                    <option value="<?php echo $messages['msg_id']; ?>"><?php echo $messages['msg_head']; ?></option>
                                                    <?php } ?>
                                                </select>
                                        <input style="background-color: #ff0050;" class="btn btn-raised" type="submit" name="submit" value="Send Mail">
                                        </div>
                                    </div>
                                <!-- end message -->
                                <input type="hidden" name="email" value="<?php echo $data['email']; ?>">
                                <input type="hidden" name="msg_id" value="<?php echo $messages['msg_id']; ?>">
                        </form>
                        </div>
                    </div>
    </div>
