...
<title>NOOR Enterprise User Account</title>
        ...
        <div class="block-header">
            <div class="row">
             ...
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">New Account</h2>
                                    <form action="controller/userSaveProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Name</h6></label>
