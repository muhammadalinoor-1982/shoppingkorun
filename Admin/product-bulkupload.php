    ...
    <div class="menu">
        <ul class="list">
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"> <i class="material-icons">add_shopping_cart</i></div><span>Bulk Upload</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="product-bulkupload.php">Bulk Upload</a></li>
                </ul>
            </li>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> Bulk Product Upload </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/productBulkSaveProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
               
					        <div class="col-lg-6 col-md-12">
                                <h6 class="noor_h6"><span class="noor_span">*</span> Upload CSV</h6>
                                    <label for="file-upload" class="custom-file-upload">
                                        <i class="material-icons">cloud_upload</i> Upload CSV
                                    </label>
                                        <input type="file" name="bulk_file" id="file-upload" />
                            </div>
