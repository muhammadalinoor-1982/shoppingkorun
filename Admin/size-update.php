<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM size WHERE size_id = '$size_id'");
...
<title>NOOR Enterprise Size Update</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add_shopping_cart</i><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="size-list.php">Size List</a></li>
                </ul>
            </li>
        ...
        <div class="block-header">
            <div class="row">
             ...
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Size Update</h2>
                                    <form action="controller/sizeUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Size Name</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['size_name']; ?>" name="size_name"  required>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-12">
                                                            <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                                                ...
                                                                <img src="uploads/size/<?php echo $data[0]['size_tag']; ?>" width="100" >
                                                        </div>

                                                <input type="hidden" name="old_img" value="<?php echo $data[0]['size_tag']; ?>">
                                                <input type="hidden" name="size_id" value="<?php echo $data[0]['size_id']; ?>">
