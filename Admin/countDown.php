...
<title>NOOR Enterprise Count Down</title>
...
<!-- AdminCC You can choose a theme from css/themes instead of get all themes --><link rel="stylesheet" href="assets/css/all-themes.css" />
    ...
    <div class="menu">
        <ul class="list">
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"> <i class="material-icons">add_shopping_cart</i></div><span>Count Down</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="countDown.php">Count Down</a></li>
...
<section class="content">
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Count Down</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card noor_card">
                            <div class="header">
                                <h5 class="noor_h5"> Count Down</h5>
        ...
        <!-- end Category head -->
        	<form action="controller/countDownSaveProcess.php" method="post" enctype="multipart/form-data">

            	<?php if (isset($_SESSION['smg'])) { echo $_SESSION['smg']; } ?>
	            ...
	            <div class="row clearfix">
                    <!-- Start Brand Name -->
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-line">
                                    <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span>Count Name</h6></label>
                                    <input type="text" name="count_name" class="form-control" placeholder="Enter Count Name" required />
                                </div>
                            </div>
                        </div>
                    <!-- end Brand Name -->
	                <!-- Start Brand Name -->
	                    <div class="col-sm-4">
	                        <div class="form-group">
	                            <div class="form-line">
	                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span>Count Down</h6></label>
	                                <input type="text" name="count_down" class="form-control" placeholder="Enter Count Down Time" required />
	                            </div>
	                        </div>
	                    </div>
	                <!-- end Brand Name -->
