...
<title>NOOR Enterprise Product Entry Form</title>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> New Product Entry </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/productSaveProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                <div class="row clearfix">
                            <div class="col-sm-6">
                ...
                <div class="row clearfix">
                            ...
                            <div class="col-lg-6"> 
                                <div class="form-group">
                                <label for="pid"><h6 class="noor_h6"> Color</h6></label><br>
                                <?php foreach ($colors as $color) { ?>
                                <input style="opacity:1; position:relative; left:0" type="checkbox" class="filled-in chk-col-blue" name="color[]" value="<?php echo $color['color_name'] ?>" />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="pid"><h6 class="noor_h6"> Size</h6></label><br>
                                <?php foreach ($sizes as $size) { ?>
                                <input style="opacity:1; position:relative; left:0" type="checkbox" class="filled-in chk-col-blue" name="size[]" value="<?php echo $size['size_name'] ?>" />
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pn"><h6 class="noor_h6"> Menufecture Counrty</h6></label>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"> Discount</h6></label>
                                        <input type="text" name="discount" class="form-control" placeholder="Enter Discount Price" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
                ...
                <!-- end Date-Time -->
                            ...
                            <div class="col-lg-6 col-md-12">
                                <h6 class="noor_h6">Other iamges</h6>
                                    <input style="display: block;" type="file" name="other_img[]" multiple="" />
                            </div>
