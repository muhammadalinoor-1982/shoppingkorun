<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM users WHERE user_type <> 0");
  $user_type = ['Admin', 'Supervisor', 'Operator'];
...
<title>NOOR Enterprise Account List</title>
                    ...
                    <!-- start data table -->
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered table-striped table-hover dataTable">
                                    <thead>
                                        <tr>
                                            <th>Select All<input type="checkbox" name="checkbox" id="all" style="position: relative; top: 0px; left: 10px; height: 0px; width: 0px;background-color: #ffffff; opacity: 1;" /></th>
                                            <th>Picture</th>
                                            <th>ID</th>
                                            <th>User Name</th>
                                            <th>Email</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="checkbox[]" value="<?php echo $value['user_id']; ?>" class="selectAll" style="position: relative; top: 40px; left: 30px; background: blue; border-radius: 4px; opacity: 1; " /></td>
                                            <td> <img src="uploads/users/<?php echo $value['images'] ? $value['images'] : 'no_img.jpg' ; ?>" width="50" height="50">  </td>
                                            <td> <?php echo $value['emp_id'] ? $value['emp_id'] : 'N/A' ; ?> </td>
                                                ...
                                                <ul class="header-dropdown">
                                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="demo-google-material-icon"> <i class="material-icons">settings</i></div>
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li><a href="new-account.php?user_id=<?php echo $value['user_id']; ?>" style="color: orange"><div class="demo-google-material-icon"> <i class="material-icons">playlist_add</i> <span class="icon-name">Create</span></div></a></li>

                                                            <li><a href="account-update.php?user_id=<?php echo $value['user_id']; ?>" style="color: green"><div class="demo-google-material-icon"> <i class="material-icons">create</i> <span class="icon-name">Edit</span> </div></a></li>

                                                            <li><a href="controller/userDeleteProcess.php?user_id=<?php echo $value['user_id']; ?>" style="color: red" onclick="return confirm('Delete All Data of the Row')"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span></div></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
