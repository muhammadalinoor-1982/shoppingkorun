<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM users WHERE user_id = '$user_id'");
...
<title>NOOR Enterprise Account Update</title>
        ...
        <ul class="list">
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">supervisor_account</i> <span class="icon-name">User Account</span></a>
                <ul class="ml-menu">
                    <li class="active"><a href="new-account.php">New Account</a></li>
        ...
        <div class="block-header">
            <div class="row">
             ...
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Account Update</h2>
                                    <form action="controller/userUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Email</h6></label>
                                                            <input type="email" class="form-control" value="<?php echo $data[0]['email'] ?>" name="email" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Password</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> First Name</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['name'] ?>" name="name" placeholder="First Name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Last Name</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Phone Number</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['phone'] ?>" name="phone" placeholder="Phone Number">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Emergency Contact</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Country</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> City</h6></label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Address</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Reference</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Ethnicity</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Nationality</h6></label>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> National ID</h6></label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Date of Birth</h6></label>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Blood Group</h6></label>
                                                    ...
                                                    <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Access Level</h6></label>
                                                                    <select class="form-control show-tick" name="user_type">
                                                                        ...
                                                                        <option value="1"<?php if($data[0]['user_type']==1) echo 'selected' ?>>Supervisor</option>
                                                                        <option value="2"<?php if($data[0]['user_type']==2) echo 'selected' ?>>Operator</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                            ...
                                                            <img src="uploads/users/<?php echo $data[0]['images']; ?>" width="100" ">
                                                </div>
                                                <input type="hidden" name="old_img" value="<?php echo $data[0]['images'] ?>">
