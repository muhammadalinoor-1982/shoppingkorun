<?php
 ...
 $obj = new DbConnection();
  ...
  $msg_id = $_GET['msg_id'];
  $data = $obj->getData("SELECT * FROM message WHERE msg_id = '$msg_id'");
...
<title>NOOR Enterprise Message Update</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"><i class="material-icons">add_shopping_cart</i></div><span>Message</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="message-list.php">Message List</a></li>
                </ul>
            </li>
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add_shopping_cart</i><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="brand-list.php">Brand List</a></li>
                </ul>
            </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Message Update</li>
                    </ul>
                </div>
            </div>
        </div>
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Message Update</h2>
                                    <form action="controller/messageUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        <?php if (isset($_SESSION['smg'])) {
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Message Head</h6></label>
                                                                <input type="text" name="head" value="<?php echo $data[0]['msg_head']; ?>" class="form-control" placeholder="Enter Message Head" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="body">
                                                    <div class="row clearfix">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label for="pd"><h6 class="noor_h6"><span class="noor_span">*</span>Message Body</h6></label>
                                                                    <textarea id="ckeditor" name="body">
                                                                        <?php echo $data[0]['msg_body']; ?>
                                                                    </textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!-- Start Link--> 
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Message Link</h6></label>
                                                                <input type="text" name="link" value="<?php echo $data[0]['msg_link']; ?>" class="form-control" placeholder="Enter Message Link" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- Start Tag--> 
                                                <div class="col-lg-6 col-md-12">
                                                            <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                                                ...
                                                                <img src="uploads/message/<?php echo $data[0]['msg_tag']; ?>" width="100" >
                                                        </div>

                                                <input type="hidden" name="old_img" value="<?php echo $data[0]['msg_tag']; ?>">
                                            <!-- end Tag -->
                                            ...
                                            <!-- Start foot--> 
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Message foot</h6></label>
                                                                <input type="text" name="foot" value="<?php echo $data[0]['msg_foot']; ?>" class="form-control" placeholder="Enter Message Foot" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="form-line">
                                                                <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Status</h6></label>
                                                                    <select class="form-control show-tick" name="status" >
                                                                        ...
                                                                        <option value="1"<?php if($data[0]['msg_status']==1) echo 'selected'; ?>>Enable</option>
                                                                        <option value="0"<?php if($data[0]['msg_status']==0) echo 'selected'; ?>>Disable</option>
                                                                    </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- end foot -->
                                            <input type="hidden" name="msg_id" value="<?php echo $data[0]['msg_id']; ?>">

                </div>
                                                
                        <div class="col-lg-12">
                            <input style="position: relative; top: 30px; left: 450px;" class="btn btn-raised btn-info" type="submit" name="submit" value="Update">
                        </div><br /><br />
                                    </form><br/>
                            </div>
    </div>
