...
<title>NOOR Enterprise slider Entry Form</title>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> New Slider Entry </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/sliderSaveProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Enter Product Code" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Name -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="header" class="form-control" placeholder="Enter Product Name" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="link" class="form-control" placeholder="Enter Quantity" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="url" class="form-control" placeholder="Enter Quantity" />
                                    </div>
                                </div>
                            </div>
