<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM review_ratting, customer, products WHERE review_ratting.customer_id = customer.customer_id AND review_ratting.product_id = products.id");
                            ...
                            <table id="example" class="table table-bordered table-striped table-hover dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['review_status'] ?'Active' :'Inactive'; ?></td>
                                            <td>
                                                <ul class="header-dropdown">
                                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="demo-google-material-icon"> <i class="material-icons">settings</i></div>
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li><a href="review-update.php?r_id=<?php echo base64_encode($value['r_id']); ?>" style="color: green"><div class="demo-google-material-icon"> <i class="material-icons">create</i> <span class="icon-name">Edit</span> </div></a></li>

                                                            <li><a href="controller/reviewDeleteProcess.php?r_id=<?php echo $value['r_id']; ?>" style="color: red" onclick="return confirm('Delete All Data of the Row')"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span></div></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
