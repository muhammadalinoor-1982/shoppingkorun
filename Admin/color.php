...
<title>NOOR Enterprise Color</title>
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- end Category head -->
        	<form action="controller/colorSaveProcess.php" method="post" enctype="multipart/form-data">
	                ...
	                <!-- Start Brand Name -->
	                    <div class="col-sm-4">
	                        <div class="form-group">
	                            <div class="form-line">
	                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Color Name</h6></label>
