<?php
 ...
 $obj = new DbConnection();
  ...
  $parents = $obj->getData("SELECT * FROM categories");

  $cat_id = $_GET['id'];
  $data = $obj->getData("SELECT * FROM categories WHERE cat_id = '$cat_id'");
...
<title>NOOR Enterprise Category Update</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add_shopping_cart</i><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="category-list.php">Category List</a></li>
        ...
        <div class="block-header">
            <div class="row">
             ...
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Category Update</h2>
                                    <form action="controller/categoryUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Category Name</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['category_name'] ?>" name="category_name" placeholder="Enter Category Name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Parent</h6></label>
                                                            <select class="form-control show-tick" name="parent_id" required>
                                                                    <option value="0">-- Set as a Parent --</option>
                                                                    <?php foreach ($parents as $parent) { ?>
                                                                    <option value="<?php echo $parent['cat_id']; ?>"
                                                                    <?php if ($data[0]['parent_id']==$parent['cat_id']) echo 'selected'; ?>>
                                                                    <?php echo $parent['category_name']; ?></option>
                                                                    <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <select class="form-control show-tick" name="cat_status" required>
                                                                        <option value="">-- Choose status --</option>
                                                                        <option value="1"<?php if($data[0]['cat_status']==1) echo 'selected' ?>>Active</option>
                                                                        <option value="0"<?php if($data[0]['cat_status']==0) echo 'selected' ?>>Inactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>

                                                <input type="hidden" name="cat_id" value="<?php echo $data[0]['cat_id'] ?>">
