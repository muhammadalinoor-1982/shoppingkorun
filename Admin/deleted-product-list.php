<?php
 ...
 $obj = new DbConnection();
  ...
  if (isset($_GET) && @$_GET['product_name'] !='') {
    ...
    $data = $obj->getData("SELECT deleted_product.*, users.name FROM deleted_product, users WHERE deleted_product.updated_by = users.user_id AND deleted_product.product_name LIKE '%$product_name%' ");
  }
  else{

    $data = $obj->getData("SELECT deleted_product.*, users.name FROM deleted_product, users WHERE deleted_product.updated_by = users.user_id ");
  }
...
<title>NOOR Enterprise Deleted Product List</title>
    ...
    <div class="menu">
        <ul class="list">
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add_shopping_cart</i><span>Deleted Product</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="deleted-product-list.php">Deleted Product List</a></li>
                </ul>
            </li>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <form action="deleted-product-list.php" method="get">
                                                ...
                                                <ul class="header-dropdown">
                                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="demo-google-material-icon"> <i class="material-icons">settings</i></div>
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li><a href="controller/restore_deleted_product.php?id=<?php echo $value['id']; ?>" style="color: green"><div class="demo-google-material-icon"> <i class="material-icons">create</i> <span class="icon-name">Restore Product</span> </div></a></li>

                                                            <li><a href="controller/productDeleteForever.php?id=<?php echo $value['id']; ?>" style="color: red" onclick="return confirm('Delete All Data of the Row')"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete Forever</span></div></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
