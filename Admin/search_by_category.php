...
<title>NOOR Enterprise Search by category</title>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-search"></i><span>Advance Search</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="search_by_category.php">search_by_category</a> </li>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card noor_card">
                    <div class="header">
                        <h5 class="noor_h5"> SEARCH BY CATEGORY </h5>
        ...
        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="category"><h6 class="noor_h6"><span class="noor_span">*</span> Category</h6></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="sub category"><h6 class="noor_h6"><span class="noor_span">*</span> Sub Category</h6></label>
                                        <select class="form-control show-tick">
        ...
        <div class="body">
                        <div class="button-demo">
                            <button style="position: absolute; top: 450px; left: 450px;" type="button" class="btn btn-raised btn-primary waves-effect">SEARCH</button>
                        </div>
        </div><br/><br/><br/><br/><br/>
        <!-- end search button -->
		<!-- Start table -->
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card noor_card">
                    <div class="header">
                        <h5 class="noor_h5"> CATEGORY WISE SEARCH RESULT </h5>
                    ...
                    <!-- Start csv, xls, pdf and print -->
                    <div class="row clearfix">
                        <div class="col-lg-6">
                            
                                <div class="body">
                                    <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group"> <a href="javascript:void(0);" class="btn bg-pink waves-effect" role="button">CSV</a> <a href="javascript:void(0);" class="btn bg-light-blue waves-effect" role="button">XLS</a> <a href="javascript:void(0);" class="btn bg-orange waves-effect" role="button">PDF</a> </div>
                                                ...
                                                <ul class="header-dropdown">
                                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="demo-google-material-icon"> <i class="material-icons">settings</i></div>
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li><a href="javascript:void(0);"><div class="demo-google-material-icon"> <i class="material-icons">playlist_add</i> <span class="icon-name">Create</span></div></a></li>

                                                            <li><a href="javascript:void(0);"><div class="demo-google-material-icon"> <i class="material-icons">create</i> <span class="icon-name">Edit</span> </div></a></li>

                                                            <li><a href="javascript:void(0);"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span></div></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
