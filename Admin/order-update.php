        ...
        <div class="block-header">
            <div class="row">
             ...
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Order Update</h2>
                                    <form action="controller/orderUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                    <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Payment Status</h6></label>
                                                                    <select class="form-control show-tick" name="payment_status">
                                                                        <option value="">-- Choose Payment Status --</option>
                                                                        <option value="0"<?php if($data[0]['payment_status']==0) echo 'selected'; ?>>Unpaid</option>
                                                                        <option value="1"<?php if($data[0]['payment_status']==1) echo 'selected'; ?>>paid</option>
                                                                    </select>
                                                                </div><br>
                                                                <div class="form-line">
                                                                    <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Order Status</h6></label>
                                                                    <select class="form-control show-tick" name="order_status">
                                                                        <option value="">-- Choose Order Status --</option>
                                                                        <option value="0"<?php if($data[0]['order_status']==0) echo 'selected'; ?>>Pending</option>
                                                                        <option value="1"<?php if($data[0]['order_status']==1) echo 'selected'; ?>>Processing</option>
                                                                        <option value="2"<?php if($data[0]['order_status']==2) echo 'selected'; ?>>shipping</option>
                                                                        <option value="3"<?php if($data[0]['order_status']==3) echo 'selected'; ?>>Complete</option>
                                                                        <option value="4"<?php if($data[0]['order_status']==4) echo 'selected'; ?>>Cancle</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
