<?php
 ...
 $obj = new DbConnection();
  ...
  $categories = $obj->getData("SELECT * FROM categories WHERE cat_status = 1");
  $brands = $obj->getData("SELECT * FROM brands WHERE brand_status = 1");
  $countries = $obj->getData("SELECT * FROM countries");
  $colors = $obj->getData("SELECT * FROM color");
  $sizes = $obj->getData("SELECT * FROM size");

  $id = base64_decode($_GET['id']);
  $data = $obj->getData("SELECT * FROM products WHERE id = '$id'");
...
<title>NOOR Enterprise Product update</title>
        ...
        <ul class="list">
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"><i class="material-icons">add_shopping_cart</i></div><span>Products</span> </a>
                <ul class="ml-menu">
                    <li class="active"><a href="form-product_entry.php">New product</a></li>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> Product Update </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/productUpdateProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="category"><h6 class="noor_h6"><span class="noor_span">*</span> Category</h6></label><!-- noor css apply "noor_h6" and "noor_span"-->
                                            <select class="form-control show-tick" data-live-search="true" name="category">
                                                <option value="">-- Chose Category --</option>

                                                <?php foreach($categories as $category){ ?>
                                                <option value="<?php echo $category['cat_id']; ?>" 
                                                    <?php if($data[0]['category_id']==$category['cat_id']) echo 'selected'; ?>>
                            ...
                            <!-- end Category option -->
                                ...
                                <!-- Start sub Category option -->
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="sub category"><h6 class="noor_h6"><span class="noor_span">*</span> Product Brand</h6></label>
                                        <select class="form-control show-tick" data-live-search="true" name="brand">
                                                <option value="">-- Chose Brand --</option>
                                                <?php foreach($brands as $brand){ ?>
                                                <option value="<?php echo $brand['brand_id']; ?>" 
                                                <?php if ($data[0]['brand_id']==$brand['brand_id']) echo 'selected'; ?>>
                ...
                <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pn"><h6 class="noor_h6"><span class="noor_span">*</span> Product Code</h6></label>
                                        <input type="text" name="product_code" class="form-control" placeholder="Enter Product Code" value="<?php echo $data[0]['product_code'];?>" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Name -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Product Name</h6></label>
                                        <input type="text" name="product_name" class="form-control" placeholder="Enter Product Name" value="<?php echo $data[0]['product_name'];?>" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
                            <div class="col-lg-6">
                                <div class="form-group"> 
                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Color</h6></label><br>
                                <?php 
                                $getColor = @json_decode($data[0]['color']);
                                foreach ($colors as $color) { ?>
                                <input style="opacity:1; position:relative; left:0" type="checkbox" class="filled-in chk-col-blue" name="color[]" value="<?php echo $color['color_name'] ?>" <?php if (@in_array($color['color_name'], $getColor)) { echo "checked"; }?> />
                            ...
                            <div class="col-lg-6">
                                <div class="form-group"> 
                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Size</h6></label><br>
                                <?php 
                                $getSize = @json_decode($data[0]['size']);
                                foreach ($sizes as $size) { ?>
                                <input style="opacity:1; position:relative; left:0" type="checkbox" class="filled-in chk-col-blue" name="size[]" value="<?php echo $size['size_name'] ?>" <?php if (@in_array($size['size_name'], $getSize)) { echo "checked"; }?> />
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pn"><h6 class="noor_h6"><span class="noor_span">*</span> Menufecture Counrty</h6></label>
                                        <select class="form-control show-tick" data-live-search="true" name="counrty">
                                                <option value="">-- Chose Counrty --</option>
                                                <?php foreach($countries as $counrty){ ?>
                                                <option value="<?php echo $counrty['country_id']; ?>" 
                                                <?php if ($data[0]['menufecture_counrty']==$counrty['country_id']) echo 'selected'; ?>>
                                                <?php echo $counrty['country_name']; ?></option>
                                                <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Price</h6></label>
                                        <input type="text" name="price" class="form-control" placeholder="Enter Price" value="<?php echo $data[0]['price']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Discount</h6></label>
                                        <input type="text" name="discount" class="form-control" placeholder="Enter Discount Price" value="<?php echo $data[0]['discount']; ?>" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Quantity</h6></label>
                                        <input type="text" name="quantity" class="form-control" placeholder="Enter Quantity" value="<?php echo $data[0]['quantity'];?>" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Feature Product</h6></label>
                                        <select class="form-control show-tick" name="feature">
                                            <option value="">-- Choose One --</option>
                                            <option value="1"<?php if($data[0]['feature_product']==1) echo 'selected' ?>>Featured</option>
                                            <option value="0"<?php if($data[0]['feature_product']==0) echo 'selected' ?>>Unfeatured</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Trending Product</h6></label>
                                        <select class="form-control show-tick" name="trending">
                                            <option value="">-- Choose One --</option>
                                            <option value="1"<?php if($data[0]['trending_product']==1) echo 'selected' ?>>Trending</option>
                                            <option value="0"<?php if($data[0]['trending_product']==0) echo 'selected' ?>>Not Trending</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="pd"><h6 class="noor_h6"><span class="noor_span">*</span>Product Description</h6></label>
                                                <textarea id="ckeditor" name="description" >
                                                     <?php echo $data[0]['product_description'];?>   
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
					        ...
					        <div class="col-lg-6 col-md-12">
                                <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                    <label for="file-upload" class="custom-file-upload">
                                        ...
                                        <img src="uploads/products/<?php echo $data[0]['product_image']; ?>" width="100" >
                            </div>

                            <input type="hidden" name="old_img" value="<?php echo $data[0]['product_image']; ?>">
