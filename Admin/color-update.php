<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM color WHERE color_id = '$color_id'");
...
<title>NOOR Enterprise Color Update</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add_shopping_cart</i><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="color.php">Color</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Color Update</li>
                    </ul>
                </div>
            </div>
        </div>
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Color Update</h2>
                                    <form action="controller/colorUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Color Name</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['color_name']; ?>" name="color_name"  required>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-12">
                                                            <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                                                ...
                                                                <img src="uploads/color/<?php echo $data[0]['color_tag']; ?>" width="100" >
                                                        </div>

                                                <input type="hidden" name="old_img" value="<?php echo $data[0]['color_tag']; ?>">
                                                <input type="hidden" name="color_id" value="<?php echo $data[0]['color_id']; ?>">
