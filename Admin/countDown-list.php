<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM count_down");
...
<title>NOOR Enterprise Count Down List</title>
    ...
    <div class="menu">
        <ul class="list">
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"> <i class="material-icons">add_shopping_cart</i></div><span>Count Down List</span> </a>
                <ul class="ml-menu">
                    <li><a href="countDown.php">Count Down</a></li>
                    <li class="active"><a href="countDown-list.php">Count Down List</a></li>
                </ul>
            </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Count Down List</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <table id="example" class="table table-bordered table-striped table-hover dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['count_status'] ?'Active' :'Inactive'; ?></td>
                                            <td> <img src="uploads/countDown/<?php echo $value['count_image'] ? $value['count_image'] : 'no-image.jpg' ; ?>" width="50" height="50">  </td>
                                            <td>
                                                <ul class="header-dropdown">
                                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="demo-google-material-icon"> <i class="material-icons">settings</i></div>
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li><a href="countDown-update.php?count_id=<?php echo $value['count_id']; ?>" style="color: green"><div class="demo-google-material-icon"> <i class="material-icons">create</i> <span class="icon-name">Edit</span> </div></a></li>

                                                            <li><a href="controller/countDownDeleteProcess.php?count_id=<?php echo $value['count_id']; ?>" style="color: red" onclick="return confirm('Delete All Data of the Row')"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span></div></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
