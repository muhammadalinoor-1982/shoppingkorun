...
<title>NOOR Enterprise Size</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"> <i class="material-icons">add_shopping_cart</i></div><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="size.php">Size</a></li>
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- end Category head -->
        	<form action="controller/sizeSaveProcess.php" method="post" enctype="multipart/form-data">
	                ...
	                <!-- Start Brand Name -->
	                    <div class="col-sm-4">
	                        <div class="form-group">
	                            <div class="form-line">
	                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Size Name</h6></label>
	                                <input type="text" name="size_name" class="form-control" placeholder="Enter Size Name" required />
	                            </div>
	                        </div>
	                    </div>
	                <!-- end Brand Name -->
