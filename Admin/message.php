...
<title>NOOR Enterprise Message</title>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> New Message Entry </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/messageSaveProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                       <!-- Start Dead--> 
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="head" class="form-control" placeholder="Enter Message Head" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="link" class="form-control" placeholder="Enter Message Link" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="foot" class="form-control" placeholder="Enter Message Foot" />
                                        </div>
                                    </div>
                                </div>
                            </div>
