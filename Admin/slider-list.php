<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM slider WHERE slider_status <> 0");
...
<title>NOOR Enterprise Slider List</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add_shopping_cart</i><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="slider-list.php">Slider List</a></li>
                            ...
                            <table id="example" class="table table-bordered table-striped table-hover dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $value['slider_header']; ?> </td>
                                            <td> <?php echo $value['slider_description']; ?> </td>
                                            <td> <?php echo $value['slider_link']; ?> </td>
                                            <td> <?php echo $value['slider_url']; ?> </td>
                                            <td> <?php echo $value['slider_status'] ? 'Enable' : 'Disable' ; ?> </td>
                                            <td> <img src="uploads/slider/<?php echo $value['slider_image'] ? $value['slider_image'] : 'no-image.jpg' ; ?>" width="50" height="50">  </td>
                                            <td>
                                                <ul class="header-dropdown">
                                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="demo-google-material-icon"> <i class="material-icons">settings</i></div>
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li><a href="slider_update.php?slider_id=<?php echo $value['slider_id']; ?>" style="color: green"><div class="demo-google-material-icon"> <i class="material-icons">create</i> <span class="icon-name">Edit</span> </div></a></li>

                                                            <li><a href="controller/sliderDeleteProcess.php?slider_id=<?php echo $value['slider_id']; ?>" style="color: red" onclick="return confirm('Delete All Data of the Row')"><div class="demo-google-material-icon"> <i class="material-icons">delete_forever</i> <span class="icon-name">Delete</span></div></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
