...
<title>NOOR Enterprise Search by Order ID</title>
        ...
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-search"></i><span>Advance Search</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"> <a href="search_by_order_id.php">search_by_order_id</a></li>
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Search by Order ID</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card noor_card">
                    <div class="header">
                        <h5 class="noor_h5"> SEARCH BY ORDER ID </h5>
        ...
        <!-- Start Product color Picker-->
                        <div class="row clearfix">
                            ...
                            <div class="col-md-1"> <b>Quantity</b>
        ...
        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="sub category"><h6 class="noor_h6"><span class="noor_span">*</span> Order ID</h6></label>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card noor_card">
                    <div class="header">
                        <h5 class="noor_h5"> ORDER ID WISE SEARCH RESULT </h5>
