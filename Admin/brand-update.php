<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM brands WHERE brand_id = '$brand_id'");
...
<title>NOOR Enterprise Brand Update</title>
        ...
        <div class="block-header">
            <div class="row">
             ...
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Brand Update</h2>
                                    <form action="controller/brandUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span> Brand Name</h6></label>
                                                            <input type="text" class="form-control" value="<?php echo $data[0]['brand_name']; ?>" name="brand_name"  required>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <select class="form-control show-tick" name="brand_status" required>
                                                                        <option value="">-- Choose status --</option>
                                                                        <option value="1"<?php if($data[0]['brand_status']==1) echo 'selected'; ?>>Active</option>
                                                                        <option value="0"<?php if($data[0]['brand_status']==0) echo 'selected'; ?>>Inactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-12">
                                                            <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                                                ...
                                                                <img src="uploads/brands/<?php echo $data[0]['brand_logo']; ?>" width="100" >
                                                        </div>

                                                <input type="hidden" name="old_img" value="<?php echo $data[0]['brand_logo']; ?>">
                                                <input type="hidden" name="brand_id" value="<?php echo $data[0]['brand_id']; ?>">
