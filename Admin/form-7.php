...
<title>NOOR Enterprise Form-3</title>
...
<nav class="navbar">
    <div class="col-12">
        <div class="navbar-header">            
            ...
            <a class="navbar-brand tfont" href="index.html">NOOR Enterprise</a>
        </div>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-home"></i><span>NOOR Admin</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="locked.html">Locked User</a></li>
                    <li><a href="forgot-password.html">Forgot Password</a> </li>
                    <li><a href="profile.html">User Profile</a> </li>
                </ul>
            </li>
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"> <i class="material-icons">add_shopping_cart</i></div><span>Product Entry Form</span> </a>
                <ul class="ml-menu">
                    <li><a href="form-product_entry.html">New product</a></li>
                    <li><a href="form-1.html">form-1</a></li>
                    <li><a href="form-2.html">form-2</a></li>
                    <li class="active"><a href="form-3.html">form-3</a></li>
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"> <i class="material-icons">search</i></div><span>Advance Search</span> </a>
                <ul class="ml-menu">
                    <li> <a href="search_by_category.html">search_by_category</a></li>
                    <li> <a href="search_by_Product_id.html">search_by_Product_id</a></li>
                    <li> <a href="search_by_order_id.html">search_by_order_id</a></li>
                    <li> <a href="search_by_complain_id.html">search_by_complain_id</a></li>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        <li class="breadcrumb-item"><a href="index.html">Noor Admin</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Product Entry Form</a></li>
