...
<title>NOOR Enterprise Brand</title>
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- end Category head -->
        	<form action="controller/brandSaveProcess.php" method="post" enctype="multipart/form-data">
	                ...
	                <!-- Start Brand Name -->
	                    <div class="col-sm-4">
	                        <div class="form-group">
	                            <div class="form-line">
	                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Brand Name</h6></label>
