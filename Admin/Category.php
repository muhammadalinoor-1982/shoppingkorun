<?php
 ...
 $obj = new DbConnection();
  ...
  $categories = $obj->getData("SELECT * FROM categories");
...
<title>NOOR Enterprise Category</title>
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- Start Category head -->
                ...
                <!-- end Category head -->
            <form action="controller/categorySaveProcess.php" method="post" enctype="multipart/form-data">
                ...
                <!-- Start Category Name -->
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="form-line">
                                <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Category Name</h6></label>
