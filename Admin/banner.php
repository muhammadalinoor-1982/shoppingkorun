...
<title>NOOR Enterprise Banner Entry Form</title>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> Banner Entry </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/bannerSaveProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="high_light" class="form-control" placeholder="Enter Product Name" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
