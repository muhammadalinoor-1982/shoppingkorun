<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM review_ratting WHERE r_id = '$r_id'");
            ...
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    ...
                    <ul class="breadcrumb">                        
                        ...
                        <li class="breadcrumb-item active">Review Update</li>
                    </ul>
                </div>
            </div>
        </div>
             <div role="tabpanel" class="tab-pane" id="usersettings">
                                <h2 class="card-inside-title" style="color: #ff4800">Review Update</h2>
                                    <form action="controller/reviewUpdateProcess.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                                    <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span>Ratting</h6></label>
                                                                        <input type="text" name="ratting" class="form-control" value="<?php echo $data[0]['ratting'];?>" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span>Review</h6></label>
                                                                        <input type="text" name="review" class="form-control" value="<?php echo $data[0]['review'];?>" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label for="date"><h6 class="noor_h6"><span class="noor_span">*</span>Review status</h6></label>
                                                                    <select class="form-control show-tick" name="review_status">
                                                                        <option value="">-- Choose Status --</option>
                                                                        <option value="0"<?php if($data[0]['review_status']==0) echo 'selected'; ?>>Inactive</option>
                                                                        <option value="1"<?php if($data[0]['review_status']==1) echo 'selected'; ?>>Active</option>
                                                                    </select>
                                                                </div><br>
                                                            </div>
                                                        </div>
