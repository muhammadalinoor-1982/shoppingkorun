<?php
 ...
 $obj = new DbConnection();
  ...
  $data = $obj->getData("SELECT * FROM slider WHERE slider_id='$slider_id'");
...
<title>NOOR Enterprise slider update Form</title>
           ...
           <li class="header nav_color">MAIN NAVIGATION</li>
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><div class="demo-google-material-icon"><i class="material-icons">add_shopping_cart</i></div><span>Products</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="slider_entry.php">New Slider</a></li>
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="Noor-color-card">
                            <div class="header">
                                <h6 style="text-align: center;"> Slider Update </h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="controller/sliderUpdateProcess.php" id="frmFileUpload" class="" method="post" enctype="multipart/form-data">
                ...
                <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="name" value="<?php echo $data[0]['slider_name']; ?>" class="form-control" placeholder="Enter Product Code" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Name -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Header</h6></label>
                                        <input type="text" name="header" value="<?php echo $data[0]['slider_header']; ?>" class="form-control" placeholder="Enter Product Name" />
                                    </div>
                                </div>
                            </div>
                            <!-- end Product Code -->
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <textarea id="ckeditor" name="description">
                                                    <?php echo $data[0]['slider_description']; ?>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> Link</h6></label>
                                        <input type="text" name="link" value="<?php echo $data[0]['slider_link']; ?>" class="form-control" placeholder="Enter Link" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pid"><h6 class="noor_h6"><span class="noor_span">*</span> URL</h6></label>
                                        <input type="text" name="url" value="<?php echo $data[0]['slider_url']; ?>" class="form-control" placeholder="Enter URL" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <select class="form-control show-tick" name="status">
                                            ...
                                            <option value="1"<?php if($data[0]['slider_status']==1) echo 'selected' ?>>Enable</option>
                                            <option value="0"<?php if($data[0]['slider_status']==0) echo 'selected' ?>>Disable</option>
                                        </select>
                                    </div>
                                </div>
                            </div>      
					        ...
					        <div class="col-lg-6 col-md-12">
                                <h6 class="noor_h6"><span class="noor_span">*</span> Upload Photo</h6>
                                    <label for="file-upload" class="custom-file-upload">
                                        ...
                                        <img src="uploads/slider/<?php echo $data[0]['slider_image']; ?>" width="100" ">
                            </div>

                            <input type="hidden" name="old_img" value="<?php echo $data[0]['slider_image'] ?>">
                            <input type="hidden" name="slider_id" value="<?php echo $data[0]['slider_id'] ?>">
