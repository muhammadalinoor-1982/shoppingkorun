...
$getkey = base64_decode(base64_decode($_GET['key']));
$ids = explode("_", $getkey);

$getCustomer = $obj->getData("SELECT * FROM customer WHERE customer_id = '".$ids[1]."'");
        ...
        <fieldset>
          <div class="registered-users">
            <div class="content">
              ...
              <p class="message">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue nec est tristique auctor. Donec non est at libero vulputate rutrum.</p>
              <ul class="form-list">
                
                <li>
                  <label for="pass">Password <span class="required">*</span></label>
                  <input type="password" title="Password" id="new_password_save" class="input-text required-entry validate-password" name="password">
                </li>
              </ul>
              <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $getCustomer[0]['customer_id']; ?>" />
              <div class="buttons-set">
                <button id="save_password" name="send" type="submit" class="button login"><span>Save new password</span></button>
