...
$products = $obj->getData("SELECT * FROM products, categories WHERE products.category_id = categories.cat_id AND categories.parent_id = '$cat_id' AND products.status=1");
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><a href="#" title="">
                <?php echo $parent_level_0['category_name']; ?></a><span>/</span>
            </li>
